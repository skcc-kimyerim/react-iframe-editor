...
from figma2code.generate_page.service.generate_page_service_abc import (
    GeneratePageServiceABC,
)
...
from figma2code.common.figma2react.page_generator import make_filename
from figma2code.common.figma2react.react_generator import (
...
class GeneratePageService(GeneratePageServiceABC):
    def __init__(self):
        pass
...
def get_generate_page_service() -> GeneratePageService:
    return GeneratePageService()
